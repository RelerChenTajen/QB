...
| `SDGs 永續發展測驗題庫.docx` | — | SDGs 永續發展 原始題目檔（本機） |
| `SDGs 永續發展測驗題庫.csv` | UTF-8 (no BOM) | SDGs 永續發展（30 題單選，類別=2.1 / 2.2 各節標題）（本機） |
| `SDGs 永續發展測驗題庫_big5.csv` | Big5 | SDGs 永續發展 Big5 版（本機） |
